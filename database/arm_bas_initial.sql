...
Source Database       : arm_bas

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2017-01-26 23:26:05
*/
...
-- ----------------------------
-- Table structure for `bas_system_history`
-- ----------------------------
DROP TABLE IF EXISTS `bas_system_history`;
CREATE TABLE `bas_system_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of bas_system_history
-- ----------------------------

-- ----------------------------
-- Table structure for `bas_system_history_hack`
-- ----------------------------
DROP TABLE IF EXISTS `bas_system_history_hack`;
CREATE TABLE `bas_system_history_hack` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `controller` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- ----------------------------
-- Records of bas_system_history_hack
-- ----------------------------
