    ...
    if(isset($CI->permissions['action6'])&&($CI->permissions['action6']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <div class="col-xs-12" style="margin-bottom: 20px;">
                ...
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="date_start"><?php echo $CI->lang->line('LABEL_DATE'); ?></label>
                ...
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="advance_for"><?php echo $CI->lang->line('LABEL_ADVANCE_BY'); ?></label>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_DATE'); ?>', dataField: 'date_start',width:'100'},
                    { text: '<?php echo $CI->lang->line('LABEL_COMPANY_NAME'); ?>', dataField: 'company_name',filtertype: 'list',width:'200'},
                    { text: '<?php echo $CI->lang->line('LABEL_ADVANCE_BY'); ?>', dataField: 'advance_for',width:'200'},
