        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Advance For', dataField: 'advance_for',width:'200'},
                    { text: 'Created By', dataField: 'created_by',width:'200'},
                    { text: 'Created Date', dataField: 'created_date',width:'100'},
                    { text: 'Check In', dataField: 'status_checkin_advance',filtertype: 'list',width:'80',cellsalign: 'right'},
                    { text: 'Approval', dataField: 'status_approval_advance',filtertype: 'list',width:'80',cellsalign: 'right'},
                    { text: 'Payment', dataField: 'status_payment_advance',filtertype: 'list',width:'80',cellsalign: 'right'},
