    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="crop_id" name="type[category_id]" class="form-control">
                    <option value=""><?php echo $this->lang->line('SELECT');?></option>
                    <?php
                    foreach($crops as $crop)
                    {?>
                        <option value="<?php echo $crop['value']?>" <?php if($crop['value']==$type['category_id']){ echo "selected";}?>><?php echo $crop['text'];?></option>
                    <?php
                    }
                    ?>
                </select>
