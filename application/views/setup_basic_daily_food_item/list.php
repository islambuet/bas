    ...
    if(isset($CI->permissions['action6'])&&($CI->permissions['action6']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <div class="col-xs-12" style="margin-bottom: 20px;">
                ...
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="quantity_person"><?php echo $CI->lang->line('LABEL_QUANTITY_PERSON'); ?></label>
    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'quantity_person', type: 'string' },
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_QUANTITY_PERSON'); ?>', dataField: 'quantity_person',width:'100',cellsalign: 'right'},
