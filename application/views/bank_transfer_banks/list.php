    ...
    if(isset($CI->permissions['action6'])&&($CI->permissions['action6']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <div class="col-xs-12" style="margin-bottom: 20px;">
                ...
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="from_bank_name">From <?php echo $CI->lang->line('LABEL_BANK_NAME'); ?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="from_account_no">From <?php echo $CI->lang->line('LABEL_ACCOUNT_NO'); ?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="to_bank_name">To <?php echo $CI->lang->line('LABEL_BANK_NAME'); ?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="to_account_no">To <?php echo $CI->lang->line('LABEL_ACCOUNT_NO'); ?></label>
    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'from_bank_name', type: 'string' },
                { name: 'from_account_no', type: 'string' },
                { name: 'to_bank_name', type: 'string' },
                { name: 'to_account_no', type: 'string' },
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'From <?php echo $CI->lang->line('LABEL_BANK_NAME'); ?>', dataField: 'from_bank_name',width:'100',filtertype: 'list'},
                    { text: '<?php echo $CI->lang->line('LABEL_ACCOUNT_NO'); ?>', dataField: 'from_account_no',width:'150'},
                    { text: 'To <?php echo $CI->lang->line('LABEL_BANK_NAME'); ?>', dataField: 'to_bank_name',width:'100',filtertype: 'list'},
                    { text: '<?php echo $CI->lang->line('LABEL_ACCOUNT_NO'); ?>', dataField: 'to_account_no',width:'150'},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_TRANSACTION_NUMBER'); ?>', dataField: 'transaction_number',width:'150'}
                ]
            });
    });
</script>