...
?>
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right">From <?php echo $CI->lang->line('LABEL_ACCOUNT_NO');?></label>
            </div>
            <div class="col-sm-4 col-xs-8">
                <?php
                foreach($accounts as $crop)
                {
                    if($crop['value']==$item['from_account_id'])
                    {
                        ?>
        ...
        <div style="" class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right">To <?php echo $CI->lang->line('LABEL_ACCOUNT_NO');?></label>
            </div>
            <div class="col-sm-4 col-xs-8">
                <?php
                foreach($accounts as $crop)
                {
                    if($crop['value']==$item['to_account_id'])
                    {
                        ?>
                        <label class="control-label"><?php echo $crop['text'];?></label>
                    <?php
