...
class Setup_basic_cashin_types extends Root_Controller
{
    private  $message;
    public $permissions;
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Setup_basic_cashin_types');
        $this->controller_url='setup_basic_cashin_types';
    ...
    {
        $this->db->from($this->config->item('table_setup_basic_cashin_types'));
